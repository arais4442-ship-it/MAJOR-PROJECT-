    ...
    try {
      ...
      setQueryResponse({
        ...
        chart_data: {
          ...
          time_series_x: ['2026-08-01', '2026-08-04', '2026-08-07', '2026-08-10', '2026-08-13', '2026-08-16', '2026-08-19', '2026-08-22'],
          time_series_y: [29.5, 28.1, 26.4, 22.0, 16.5, 12.1, 8.4, 5.2],
          time_series_x_label: 'Date',
          time_series_y_label: 'Temperature (°C)',
